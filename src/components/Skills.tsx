...
const skills = [
  {
    category: 'Frontend',
    items: ['React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'HTML/CSS', 'JavaScript', 'jQuery', 'Bootstrap', 'Material UI',],
  },
  {
    category: 'Backend',
    items: ['Node.js', 'Express', 'Python', 'Django', 'SQL', 'Java', 'C/C++', 'JCL', 'Cobol', 'Pandas', 'BeautifulSoup', 'FastAPI'],
  },
  {
    category: 'Tools & Others',
    items: ['Git', 'Docker', 'IBM Mainframe', 'Linux', 'Unity', 'VScode', 'IBM Watson X', 'PostMan'],
  },
]
