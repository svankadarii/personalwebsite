...
const projects = [
  ...
  },
  {
    ...
    description: 'Webcam based pantry tracker that detects items and adds to pantry with ai chatbot to help with recipes',
    technologies: ['Next.js', 'NextAuth', 'Tailwind CSS', 'Google Cloud Vision API', 'Firebase', 'OpenAI API',],
    image: '/project2.jpg',
    link: '#',
  },
  {
